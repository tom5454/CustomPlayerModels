...
public class SourceOrigin implements SourceInfo {
	...
	private static class SourceOriginPos extends SourceOrigin {
		...
		private SourceOriginPos(String location, int startLine, int startPos, int endPos, String symbol) {
			super(location, startLine, symbol);
	...
	public static final SourceOrigin UNKNOWN = new SourceOrigin("Unknown", 0, null) {
	...
	public static SourceOrigin create(int startPos, int endPos, int startLine, String fileName) {
		...
		return new SourceOriginPos(fileName, startLine, startPos, endPos, null);
	}

	public static SourceOrigin create(int startPos, int endPos, int startLine, String fileName, String symbol) {
		if (startPos < 0 && endPos < 0) {
			return create(startLine, fileName);
		}

		return new SourceOriginPos(fileName, startLine, startPos, endPos, symbol);
	}
	...
	public static SourceOrigin create(int startLine, String fileName) {
		...
		SourceOrigin newInstance = new SourceOrigin(fileName, startLine, null);
	...
	private final String fileName, symbol;
	private final int startLine;

	private SourceOrigin(String location, int startLine, String symbol) {
