...
public class PngChunkBKGD extends PngChunkSingle {
	...
	public void setGray(int gray) {
		if (!imgInfo.greyscale) throw new PngjException("only gray images support this");
		this.gray = gray;
	}
	...
	public void setPaletteIndex(int i) {
		if (!imgInfo.indexed) throw new PngjException("only indexed (pallete) images support this");
		this.paletteIndex = i;
	}
