...
public abstract class PngChunkTextVar extends PngChunkMultiple {
	...
	public final static String KEY_Title = "Title"; // Short (one line) title or
													// caption for image
	public final static String KEY_Author = "Author"; // Name of image's creator
	public final static String KEY_Description = "Description"; // Description
																// of image
																// (possibly
																// long)
	public final static String KEY_Copyright = "Copyright"; // Copyright notice
	public final static String KEY_Creation_Time = "Creation Time"; // Time of
																	// original
																	// image
																	// creation
	public final static String KEY_Software = "Software"; // Software used to
															// create the image
	public final static String KEY_Disclaimer = "Disclaimer"; // Legal
																// disclaimer
	public final static String KEY_Warning = "Warning"; // Warning of nature of
														// content
	public final static String KEY_Source = "Source"; // Device used to create
														// the image
