...
import com.tom.cpm.web.client.java.Pattern;
...
public class ChunkHelper {
	...
	/*
	 * static auxiliary buffer. any method that uses this should synchronize
	 * against this
	 */
	...
	public static final boolean equivalent(PngChunk c1, PngChunk c2) {
		...
		// same id
		if (c1.getClass() != c2.getClass()) return false; // should not happen
	...
	public static String idFromBytes(byte[] buf, int offset) {
		if (buf == null || buf.length < 4 + offset) return "?";
