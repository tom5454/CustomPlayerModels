...
public class PngChunkTIME extends PngChunkSingle {
	...
	public void parseFromRaw(ChunkRaw chunk) {
		if (chunk.len != 7) throw new PngjException("bad chunk " + chunk);
	...
	public String getAsString() {
		return com.tom.cpm.web.client.java.Java.format("%04d/%02d/%02d %02d:%02d:%02d", year, mon, day, hour, min, sec);
	}
