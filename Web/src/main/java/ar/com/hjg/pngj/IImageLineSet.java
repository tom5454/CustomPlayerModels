...
public interface IImageLineSet<T extends IImageLine> {
	...
	/**
	 * Asks for imageline corresponding to row <code>n</code> in the original
	 * image (zero based). This can trigger side effects in this object (eg,
	 * advance a cursor, set current row number...) In some scenarios, this
	 * should be consider as alias to (pseudocode)
