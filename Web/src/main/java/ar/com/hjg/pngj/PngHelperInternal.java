...
import com.tom.cpm.web.client.java.io.FileOutputStream;
...
public final class PngHelperInternal {
	...
	public static void logdebug(String msg) {
		if (isDebug()) System.err.println("logdebug: " + msg);
	}
	...
	public static int filterRowPaeth(int r, int left, int up, int upleft) { // a
																			// =
																			// left,
																			// b
																			// =
	...
	final static int filterPaethPredictor(final int a, final int b, final int c) { // a
																					// =
																					// left,
																					// b
																					// =
	...
	public static long getRawIdatBytes(PngReader r) { // in case of image with
														// frames, returns the
														// current one
