...
public class PngChunkICCP extends PngChunkSingle {
	...
	private byte[] compressedProfile; // copmression/decopmresion is done in
										// getter/setter
	...
	public ChunkRaw createRawChunk() {
		...
		System.arraycopy(ChunkHelper.toBytesLatin1(profileName), 0, c.data, 0, profileName.length());
	...
	public void parseFromRaw(ChunkRaw chunk) {
		...
		if (comp != 0) throw new PngjException("bad compression for ChunkTypeICCP");
	...
	public void setProfileNameAndContent(String name, String profile) {
		setProfileNameAndContent(name, ChunkHelper.toBytesLatin1(profile));
	}
	...
	public String getProfileAsString() {
		return ChunkHelper.toStringLatin1(getProfile());
	}
