...
public class KeyBindings implements IKeybind {
	...
	public static void init(RegisterKeyMappingsEvent evt) {
		...
		gestureMenuBinding = new KeyMapping("key.cpm.gestureMenu", KeyConflictContext.IN_GAME, InputConstants.Type.KEYBOARD.getOrCreate(InputConstants.KEY_H), category);
