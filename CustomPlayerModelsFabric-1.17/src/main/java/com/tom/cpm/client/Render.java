...
public class Render {
	...
	public static class ColorBox implements Box {
		...
		public void draw(MatrixStack matrixStackIn, VertexConsumer bufferIn, VertexConsumerProvider buf, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
			...
			for(TexturedQuad modelrenderer$texturedquad : quadList) {
				net.minecraft.util.math.Vec3f vector3f = modelrenderer$texturedquad.normal.copy();
	...
	static class PositionTextureVertex {
		public final net.minecraft.util.math.Vec3f position;
		public final float textureU;
		public final float textureV;

		public PositionTextureVertex(float x, float y, float z, float texU, float texV) {
			this(new net.minecraft.util.math.Vec3f(x, y, z), texU, texV);
		}
		...
		public PositionTextureVertex(net.minecraft.util.math.Vec3f posIn, float texU, float texV) {
			this.position = posIn;
			this.textureU = texU;
			this.textureV = texV;
		}
	...
	static class TexturedQuad {
		...
		public final net.minecraft.util.math.Vec3f normal;
