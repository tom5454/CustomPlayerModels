...
public class ServerHandler {
	public static NetHandlerExt<Identifier, PlayerEntity, ServerNetworkImpl> netHandler;

	static {
		netHandler = new NetHandlerExt<>((a, b) -> Identifier.of(a + ":" + b));
		netHandler.setGetPlayerUUID(p -> UUID.nameUUIDFromBytes(("OfflinePlayer:" + p.name).getBytes(StandardCharsets.UTF_8)));
