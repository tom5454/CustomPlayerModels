...
public class GuiRenderStates {
	public record Colored4RectangleRenderState(
		...
		public void buildVertices(VertexConsumer vertexConsumer) {
			vertexConsumer.addVertexWith2DPose(this.pose(), this.x0(), this.y0()).setColor(this.topLeft());
			vertexConsumer.addVertexWith2DPose(this.pose(), this.x0(), this.y1()).setColor(this.bottomLeft());
			vertexConsumer.addVertexWith2DPose(this.pose(), this.x1(), this.y1()).setColor(this.bottomRight());
			vertexConsumer.addVertexWith2DPose(this.pose(), this.x1(), this.y0()).setColor(this.topRight());
		}
	}
