...
Tested with Blockbench desktop 4.1.1 portable
...
`https://tom5454.com/cpm/cpm_plugin.js`  
...
## Usage
You can import .cpmproject files, or start from scratch. It is recommended that you start with the `Customizable Player Models model` Preset. If you have a different model use File/Convert Project and change it to `Customizable Player Models model`.  
