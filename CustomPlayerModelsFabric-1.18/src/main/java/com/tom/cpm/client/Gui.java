...
public class Gui extends Screen {
	...
	public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
		try {
			...
			gui.keyPressed(evt);
			if(!evt.isConsumed()) {
				if(client.player != null && client.options.chatKey.matchesKey(keyCode, scanCode) && client.options.chatVisibility != ChatVisibility.HIDDEN) {
