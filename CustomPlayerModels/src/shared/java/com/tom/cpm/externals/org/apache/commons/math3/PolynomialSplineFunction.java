 ...
 * <i>interpolating polynomials</i> and an ascending array of domain <i>knot
 * points</i>, determining the intervals over which the spline function is
 * defined by the constituent polynomials. The polynomials are assumed to have
 * been computed to match the values of another function at the knot points. The
 * value consistency constraints are not currently enforced by
 ...
 * <code>[smallest knot, largest knot]</code>. Attempts to evaluate the function
...
public class PolynomialSplineFunction {
	...
	/**
	 * Get the number of spline segments. It is also the number of polynomials
	 * and the number of knot points - 1.
	 *
	...
	/**
	 * Get a copy of the interpolating polynomials array. It returns a fresh
	 * copy of the array. Changes made to the copy will not affect the
	...
	/**
	 * Get an array copy of the knot points. It returns a fresh copy of the
	 * array. Changes made to the copy will not affect the knots property.
	 *
