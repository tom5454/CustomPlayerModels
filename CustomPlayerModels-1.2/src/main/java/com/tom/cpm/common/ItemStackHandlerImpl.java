...
public class ItemStackHandlerImpl extends ItemStackHandler<ItemStack> {
	...
	public boolean itemEqualsFull(ItemStack a, ItemStack b) {
		return (a == null && b == null ? true : (a != null && b != null ? a.isItemEqual(b) : false)) && ItemStack.func_46154_a(a, b);
	}
	...
	public static class NBT extends NbtMapper<NBTBase, net.minecraft.src.NBTTagCompound, NBTTagList, NBTPrimitive> {
		...
		public int[] getIntArray(NBTBase t) {
			return t instanceof NBTTagIntArray ? ((NBTTagIntArray) t).field_48181_a : new int[0];
		}
