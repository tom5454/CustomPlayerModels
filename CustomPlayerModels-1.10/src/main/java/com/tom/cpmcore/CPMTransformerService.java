	...
	public static void init() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if(method.desc.equals("(FFFLnet/minecraft/util/EnumFacing;FILcom/mojang/authlib/GameProfile;IF)V") ||
							method.desc.equals("(FFFLct;FILcom/mojang/authlib/GameProfile;IF)V")) {
						m = method;
		...
		transformers.put("net.minecraft.client.model.ModelBiped", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if((method.name.equals("a") && method.desc.equals("(FFFFFFLrw;)V")) || method.name.equals("setRotationAngles")) {
		...
		transformers.put("net.minecraft.client.renderer.entity.layers.LayerArmorBase", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if((method.name.equals("a") && method.desc.equals("(Lsf;FFFFFFFLsb;)V")) || method.name.equals("renderArmorLayer")) {
						...
						for (ListIterator<AbstractInsnNode> it = method.instructions.iterator(); it.hasNext(); ) {
							...
							if(insnNode instanceof MethodInsnNode) {
								...
								if((mn.name.equals("a") && mn.desc.equals("(Lrw;FFFFFF)V")) || mn.name.equals("render")) {
					...
					} else if((method.name.equals("a") && method.desc.equals("(Lsf;FFFFFFF)V")) || method.name.equals("doRenderLayer")) {
					...
					} else if((method.name.equals("a") && method.desc.equals("(Lbsy;Lsf;Lbju;FFFFFFF)V")) || method.name.equals("renderEnchantedGlint")) {
		...
		transformers.put("net.minecraft.client.renderer.entity.layers.LayerCustomHead", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if((method.name.equals("a") && method.desc.equals("(Lsf;FFFFFFF)V")) || method.name.equals("doRenderLayer")) {
		...
		transformers.put("net.minecraft.client.renderer.entity.RenderPlayer", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					...
					if(method.name.equals("renderRightArm") || (method.name.equals("b") && method.desc.equals("(Lbnk;)V"))) {
					...
					if(method.name.equals("renderLeftArm") || (method.name.equals("c") && method.desc.equals("(Lbnk;)V"))) {
		...
		transformers.put("net.minecraft.client.Minecraft", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if(method.name.equals("loadWorld") || (method.name.equals("a") && method.desc.equals("(Lbln;Ljava/lang/String;)V"))) {
						LOG.info("CPM ClientLogout Hook: Found loadWorld");
						for (ListIterator<AbstractInsnNode> it = method.instructions.iterator(); it.hasNext(); ) {
							AbstractInsnNode insnNode = it.next();
							if(insnNode instanceof MethodInsnNode) {
								MethodInsnNode mn = (MethodInsnNode) insnNode;
								if((mn.name.equals("b") && mn.desc.equals("()V") && mn.getPrevious() instanceof FieldInsnNode && ((FieldInsnNode)mn.getPrevious()).name.equals("q")) || mn.name.equals("clearAchievements")) {
		...
		transformers.put("net.minecraft.client.network.NetHandlerPlayClient", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if(method.name.equals("handleCustomPayload") || (method.name.equals("a") && method.desc.equals("(Lgl;)V"))) {
		...
		transformers.put("net.minecraft.network.NetHandlerPlayServer", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				...
				for(MethodNode method : input.methods) {
					if(method.name.equals("processCustomPayload") || (method.name.equals("a") && method.desc.equals("(Lit;)V"))) {
		...
		transformers.put("net.minecraft.client.renderer.entity.layers.LayerElytra", new UnaryOperator<ClassNode>() {
			...
			public ClassNode apply(ClassNode input) {
				for(MethodNode method : input.methods) {
					if((method.name.equals("a") && method.desc.equals("(Lbnk;FFFFFFF)V")) || method.name.equals("doRenderLayer")) {
						...
						for (ListIterator<AbstractInsnNode> it = method.instructions.iterator(); it.hasNext(); ) {
							...
							if(insnNode instanceof MethodInsnNode) {
								MethodInsnNode mn = (MethodInsnNode) insnNode;
								if(mn.desc.equals("()V") && (mn.name.equals("pushMatrix") || (mn.name.equals("G") && mn.owner.equals("bob")))) {
								...
								} else if(mn.desc.equals("()V") && (mn.name.equals("popMatrix") || (mn.name.equals("H") && mn.owner.equals("bob")))) {
