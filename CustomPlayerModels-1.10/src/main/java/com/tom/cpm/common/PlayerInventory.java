...
public class PlayerInventory implements Inventory {
	...
	public int getNamedSlotId(NamedSlot slot) {
		...
		case ARMOR_BOOTS: return EntityEquipmentSlot.FEET.getIndex() + inv.mainInventory.length;
		case ARMOR_CHESTPLATE: return EntityEquipmentSlot.CHEST.getIndex() + inv.mainInventory.length;
		case ARMOR_HELMET: return EntityEquipmentSlot.HEAD.getIndex() + inv.mainInventory.length;
		case ARMOR_LEGGINGS: return EntityEquipmentSlot.LEGS.getIndex() + inv.mainInventory.length;
		case OFF_HAND: return inv.mainInventory.length + inv.armorInventory.length;
