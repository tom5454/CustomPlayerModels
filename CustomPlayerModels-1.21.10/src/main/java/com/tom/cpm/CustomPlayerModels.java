...
public class CustomPlayerModels extends CommonBase {
	...
	public CustomPlayerModels(IEventBus bus) {
		...
		if (FMLEnvironment.getDist() == Dist.CLIENT) CustomPlayerModelsClient.INSTANCE.preInit(bus);
	...
	private void processIMC(final InterModProcessEvent event) {
		...
		apiInit();
		if(FMLEnvironment.getDist() == Dist.CLIENT)CustomPlayerModelsClient.apiInit();
	}
