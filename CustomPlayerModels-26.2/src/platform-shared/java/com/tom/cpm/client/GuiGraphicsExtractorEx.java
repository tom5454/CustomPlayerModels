...
public interface GuiGraphicsExtractorEx {
	...
	<I, S extends PictureInPictureRenderState> void cpm$pip(I instance, int x0, int y0, int x1, int y1, StateFactory<I, S> sf);
	...
	public static interface RegistrationHandler {
		<T extends PictureInPictureRenderState> void register(Class<T> stateClass, Supplier<PictureInPictureRenderer<T>> factory);
	}
}