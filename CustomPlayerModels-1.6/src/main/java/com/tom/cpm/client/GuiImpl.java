...
public class GuiImpl extends GuiScreen implements IGui {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		try {
			...
			String s = "Minecraft 1.6.4 (" + ClientBrandRetriever.getClientModName() + ") " + Loader.instance().getIndexedModList().get(CustomPlayerModels.ID).getDisplayVersion();
	...
	public void displayError(String e) {
		GuiScreen p = parent;
		parent = null;
		Minecraft.getMinecraft().displayGuiScreen(new GuiErrorScreen("Custom Player Models", I18n.getStringParams("error.cpm.crash", e)) {
	...
	public String i18nFormat(String key, Object... obj) {
		return I18n.getStringParams(key, obj);
	}
	...
	public void drawStack(int x, int y, Stack stack) {
		...
		itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.getTextureManager(), s, x, y);
		itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.mc.getTextureManager(), s, x, y, null);
