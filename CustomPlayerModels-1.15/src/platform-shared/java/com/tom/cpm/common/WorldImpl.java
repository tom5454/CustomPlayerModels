...
public class WorldImpl implements World {
	...
	public static void setWorld(AnimationState a, Entity ent) {
		...
		i.level.set(l);
		i.base = ent.getCommandSenderBlockPosition();
		a.dayTime = l.getDayTime();
	...
	public int getMaxHeight() {
		return level.call(l -> l.getMaxBuildHeight(), 0);
	}
	...
	public String getDimension() {
		return level.call(l -> Registry.DIMENSION_TYPE.getKey(l.getDimension().getType()).toString(), null);
	}
}
